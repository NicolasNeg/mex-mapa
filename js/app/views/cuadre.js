// ═══════════════════════════════════════════════════════════
//  /js/app/views/cuadre.js — Bridge view
//  El módulo completo vive en js/views/cuadre.js.
// ═══════════════════════════════════════════════════════════
...
function _html(profile, role) {
  ...
  return _bridge({
    ...
    gradFrom:    '#7f1d1d',
    gradTo:      '#991b1b',
    title:       'Cuadre operativo',
    subtitle:    'Resumen financiero y operativo del turno',
    legacyRoute: '/cuadre',
    ctaLabel:    'Abrir cuadre',
    user:        { name, roleLabel, plaza },
    features: [
      ['payments',         'Resumen de cobros'],
      ['receipt_long',     'Reporte de turno'],
      ['bar_chart',        'Estadísticas'],
      ['compare_arrows',   'Comparativa de plazas'],
      ['download',         'Exportar PDF'],
      ['history',          'Historial de cuadres'],
    ],
    note: 'El módulo de cuadre con cálculos en tiempo real está disponible en la ruta legacy.'
  });
}
