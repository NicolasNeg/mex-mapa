...
export function normalizeUserRecord(id, data = {}) {
  ...
  return {
    ...
    licenciaArchivoUrl: String(data.licenciaArchivoUrl || data.licenciaUrl || '').trim(),
    licenciaArchivoPath: String(data.licenciaArchivoPath || '').trim(),
    licenciaArchivoPublicId: String(data.licenciaArchivoPublicId || '').trim(),
    licenciaArchivoProvider: String(data.licenciaArchivoProvider || '').trim(),
    licenciaArchivoNombre: String(data.licenciaArchivoNombre || '').trim(),
    licenciaArchivoTipo: String(data.licenciaArchivoTipo || '').trim(),
    licencias: Array.isArray(data.licencias) ? data.licencias : [],
    licenciaUrls: Array.isArray(data.licenciaUrls) ? data.licenciaUrls : [],
